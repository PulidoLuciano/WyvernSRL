  ...
  return (
    <main className='p-12'>
      ...
      <Accordion title="Filtrar por">
        <form action="" className='grid grid-cols-3 grid-rows-3 gap-y-12 gap-x-64' >
          ...
          <button type='submit' className='text-white bg-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 col-start-3 place-self-end'>
      ...
      <div className='grid grid-rows-1 grid-cols-6 gap-x-2'>
        <h2>Clientes</h2>
        <p className='self-center'>Página 1 de 20</p>
        <button className='bg-red font-semibold col-start-5 col-end-6 rounded flex gap-2 items-center justify-center'>
          <svg className="w-6 h-6 text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 7h14m-9 3v8m4-8v8M10 3h4a1 1 0 0 1 1 1v3H9V4a1 1 0 0 1 1-1ZM6 7h12v13a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7Z" />
          </svg>

          Eliminar Seleccionados (0)</button>
        <button className='bg-primary font-semibold col-start-6 col-end-7 rounded flex gap-2 items-center justify-center text-white'>
      ...
      <table className='w-full'>
        <thead className=''>
          <th className='p-2 text-start '><input type="checkbox" onChange={handleCheckAll} className='me-2' /> Nombre</th>
        ...
        <tbody>
          <td className=' p-2 '><input type="checkbox" className='me-2' /> Juan</td>
          <td className=' p-2 '>steam</td>
          <td className=' p-2 '>argentina</td>
          <td className=' p-2 '>si</td>
          <td className=' p-2 '>juan@gmail.com</td>
      ...
      <div className='flex items-center justify-end gap-6 my-6' id='paginacionTabla'>
        <span>
          <svg className="w-6 h-6 text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <a href="" className='bg-primary rounded-md p-3 text-white'>1</a>
        <a href="">2</a>
        <a href="">3</a>
        <a href="">4</a>
        <span>
